...
if [ $# -ne 4 ]
then
    echo "Script expects four arguments; an input file name, an output file name, an attachment file name and a file UID." 1>&2
    exit 1
fi
...
python -B "MkvEdit.py" "change_attachment_fileuid" "$1" "$2" "$3" "$4"
